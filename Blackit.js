 ...
 * 
 * This code was generated by build.bat 
 */ 
...
const cleanChatColor 			= str => str.replace(/Â§[0-9a-fk-or]/g, ""); 
...
const Console = { 
	lines: "" 
		+ ChatColor.AQUA + 	"? â–¡?¡â– ? â– ? â– ?¡â–¡? â– ?¡â–¡?¡â–¡?¡â–¡?¡â–¡?¡â–¡?¡â–¡?¡â– ? â–¡?¡â–¡?¡â–¡? â– ?¡â–¡? â– ?¡â–¡?¡â–¡?¡â– \n".replace(/? â–¡/g, "?? + ChatColor.BLACK + "??).replace(/?¡â– /g, "?? + ChatColor.AQUA + "??) 
		+ ChatColor.BLACK + "?¡â– ?¡â– ? â–¡?¡â– ? â–¡? â– ?¡â–¡? â– ? â– ?¡â–¡? â– ? â– ?¡â– ? â–¡? â– ?¡â–¡?¡â–¡?¡â– ? â– ? â– ?¡â– ?¡â–¡\n".replace(/? â–¡/g, "?? + ChatColor.BLACK + "??).replace(/?¡â– /g, "?? + ChatColor.AQUA + "??) 
		+ ChatColor.AQUA + 	"? â– ?¡â– ? â– ? â– ?¡â–¡? â– ?¡â– ? â–¡? â– ?¡â– ? â–¡?¡â–¡?¡â– ? â– ? â–¡?¡â–¡? â– ?¡â–¡? â– ?¡â–¡?¡â–¡?¡â– \n".replace(/? â–¡/g, "?? + ChatColor.BLACK + "??).replace(/?¡â– /g, "?? + ChatColor.AQUA + "??) 
		+ ChatColor.BLACK + "?¡â–¡? â– ? â–¡?¡â– ? â–¡? â– ?¡â– ? â–¡? â– ?¡â– ? â–¡?¡â–¡?¡â– ? â–¡? â– ?¡â–¡? â– ?¡â–¡? â– ?¡â–¡?¡â– ? â–¡\n".replace(/? â–¡/g, "?? + ChatColor.BLACK + "??).replace(/?¡â– /g, "?? + ChatColor.AQUA + "??) 
		+ ChatColor.AQUA + 	"? â–¡?¡â– ? â– ? â– ?¡â–¡? â– ?¡â–¡? â– ? â– ?¡â–¡? â– ? â– ?¡â– ? â–¡?¡â– ? â–¡? â– ?¡â–¡?¡â– ? â– ? â– ?¡â– \n".replace(/? â–¡/g, "?? + ChatColor.BLACK + "??).replace(/?¡â– /g, "?? + ChatColor.AQUA + "??) 
		+ "\n" 
	...
	init: function(){ 
		this.register({ 
			...
			execute: function(args){ 
				Console.info("Â§lÂ§aCommand list"); 
		...
		this.register({ 
			...
			aliases: ["ver", "about"], 
			execute: function(args){ 
				Console.info("Â§lÂ§aBlackit version"); 
		...
		this.register({ 
			...
			execute: function(args){ 
				...
				Console.info("Â§lÂ§aEval result"); 
				var code = args.join(" "); 
